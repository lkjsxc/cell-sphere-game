...
export const MASTERY_TROPHIES = family('mastery', [
  ...
  ['survival-axis', 'Complete Survival', 'Fill Survival after completing at least one mature event era.', all(n('survivalAxisBp', 9500), n('runs', 11))],
  ...
  ['spread-axis', 'Mastered Spread', 'Raise sustained Reach to 50% with long lake-centered living.', all(n('spreadAxisBp', 5000), n('lakeLivingSeconds', 180), n('skillCount', 84))],
