...
export const EVOLUTION_TROPHIES = family('evolution', [
  ...
  ['fifty-worlds', 'Fifty Worlds', 'Complete 50 worlds and establish at least 42 Evolution cells.', all(n('runs', 50), n('skillCount', 42))],
  ...
  ['authored-landmarks', 'Authored Sphere', 'Establish 42 permanent Evolution cells.', n('skillCount', 42)],
  ['half-globe', 'Growing Sphere', 'Unlock 21 permanent Evolution cells to Level 1+.', n('skillCount', 21)],
  ['whole-globe', 'Breadth Complete', 'Establish 42 Evolution cells across every specialization domain; local refinements remain unlimited.', all(n('skillCount', 42), n('skillBranchCount', 6))],
