...
export const REACH_MEMORY = defineBranch('reach', [
  ...
  ['dryland-runners', 'Dryland Runners', 'Reach rises when local moisture is low.', 'Margins probe nearby viable ground before drying closes their remaining routes.', 8, c('moisture-below-30', 'reach', 1.10)],
  ['brackish-membrane', 'Brackish Membrane', 'Permit shallow-ocean edge colonization.', 'Life may cross from established coasts or lake-outlet ecology into adjacent shallow ocean.', 5, u('SHALLOW_OCEAN_EDGE_ACCESS', 'habitat')],
  ['pelagic-lattice', 'Pelagic Lattice', 'Permit general shallow-ocean colonization.', 'A bounded pelagic scaffold opens shallow water while route cost and maintenance still constrain spread.', 7, u('SHALLOW_OCEAN_ACCESS', 'habitat')],
