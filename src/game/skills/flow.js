...
export const FLOW_MEMORY = defineBranch('flow', [
  ...
  ['floodplain-network', 'Floodplain Network', 'Transport rises in well-watered local conditions.', 'Seasonal moisture spreads local abundance through spare channels before a single route can monopolize it.', 6, c('moisture-above-70', 'conductance', 1.10)],
  ...
  ['sparse-pulse', 'Sparse Pulse', 'Reinforcement rises when connectivity is very low.', 'A coherent pulse protects the few routes still carrying useful exchange.', 8, c('connectivity-below-35', 'reinforce', 1.12)],
