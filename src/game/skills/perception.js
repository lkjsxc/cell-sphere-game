...
export const PERCEPTION_MEMORY = defineBranch('perception', [
  ...
  ['distributed-watch', 'Distributed Watch', 'Stress resistance rises by 3%.', 'Many small observers recognize chronic environmental change before the living core carries its full cost.', 4, s('stressResist', 1.03)],
  ...
  ['alarm-clarity', 'Signal Clarity', 'Stress resistance rises under toxin pressure.', 'Persistent environmental patterns become easier to distinguish as toxicity accumulates.', 5, c('toxin-pressure-above-50', 'stressResist', 1.14)],
  ...
  ['forecast-window', 'Frontier Window', 'Reach rises while coverage remains sparse.', 'Autonomous frontiers use an open niche before nearby reserves become crowded.', 7, c('coverage-below-25', 'reach', 1.10)],
  ...
  ['cell-chronicle', 'Cell Chronicle', 'Unlock deeper per-cell History context.', 'The inspector can relate a selected location to meaningful History records.', 5, u('cellChronicle', 'information', s('stressResist', 1.01))],
  ['pressure-forecast', 'Pressure Reading', 'Unlock chronic Environment context.', 'History and inspection expose the current Environment transition rather than false exact prediction.', 7, u('pressureForecast', 'information', s('stressResist', 1.02))],
  ...
  ['sensed-habitat', 'Sensed Habitat', 'Perception and Ecology improve local uptake.', 'The two currents converge into one additional layer of local habitat reading.', 18, u('perceptionEcologyConfluence', 'connector', s('uptake', 1.02))],
