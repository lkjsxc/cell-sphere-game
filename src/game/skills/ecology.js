...
export const ECOLOGY_MEMORY = defineBranch('ecology', [
  ['tempered-scars', 'Tempered Scars', 'Stress resistance rises by 8%.', 'Past depletion leaves tissue prepared for chronic pressure without making the next world harmless.', 2, s('stressResist', 1.08)],
  ...
  ['warm-range-memory', 'Warm-Range Memory', 'Heat tolerance widens above warm local conditions.', 'A rising chronic temperature activates remembered proteins before widespread damage accumulates.', 5, c('temperature-above-75', 'heatTol', 1.14)],
  ...
  ['succession-window', 'Succession Window', 'Regrowth rises after substantial biomass loss.', 'Survivors recolonize local scars before depleted ground closes their remaining routes.', 8, c('recent-biomass-loss-above-20', 'regrow', 1.16)],
  ...
  ['seasonal-shelter', 'Seasonal Shelter', 'Unlock seasonal shelter rules.', 'A saved rule may favor locally buffered cells as chronic moisture and temperature pressure rise.', 9, u('seasonalShelter', 'automation')],
