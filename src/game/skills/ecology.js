...
export const ECOLOGY_MEMORY = defineBranch('ecology', 'reserve-deepwell-crown', [
  ...
  ['lichen-strain', 'Lichen Strain', 'Unlock the Lichen starting morphology.', 'A slow cooperative strain can be selected for worlds defined by chronic pressure.', 5, u('lichenStrain', 'mechanic')],
  ['habitat-reading', 'Habitat Reading', 'Reveal local tolerance margins.', 'The atlas shows how close visible tissue is to heat, drought, and toxin limits.', 7, u('habitatReading', 'information')],
