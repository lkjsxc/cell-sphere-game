...
Pure, frozen content and graph rules for the 642-cell Evolution Globe.
...
Every Skill Cell has one stable ID, one exact effect, one cost, one visible gate,
and either no prerequisite or a prerequisite sharing its cell boundary.
