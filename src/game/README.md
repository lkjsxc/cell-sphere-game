...
| `memory.js` | 108-cell atlas graph, queries, transactions, compilation, and validation. |
| `memory-node.js` | Shared immutable cell/effect schema and completed milestone bonuses. |
| `memory-{branch}.js` | Eighteen authored cells for each of six progression branches. |
...
- Six Memory branches contain exactly 18 cells; IDs and locations are stable.
