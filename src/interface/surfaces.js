...
export function elements() {
  return {
    ...
    memoryAvailable: byId('memory-available'), continuation: byId('result-continuation'),
    continuationVisible: byId('result-continuation-visible'), continuationAccessible: byId('result-continuation-accessible'),
    continuationTrace: byId('result-continuation-trace'), resultFirstCycle: byId('result-first-cycle'),
