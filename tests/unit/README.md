...
clock debt, projected World geometry, the six-entry camera sample window,
30/60/120 Hz damping equivalence, long-run free-orbit orthonormality, shared
trusted interaction, and Result-cycle progress/text cadence. Browser behavior is
still proved in the trusted production browser harness, not inferred here.
