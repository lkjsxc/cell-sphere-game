...
| Location | Coverage |
|---|---|
| `unit/` | Deterministic primitives/simulation; exact progression integers; connected substrate-guided Evolution layout; Environment compiler; realized SCORE; shared rendering semantics; persistence reset and presentation state machines. |
