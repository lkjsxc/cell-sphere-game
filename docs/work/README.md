...
This directory holds temporary, cross-layer implementation packages. Canonical
product and engineering truth belongs in root documentation and source; packages
...
- [`autonomous-world-contract-closure-v1/`](autonomous-world-contract-closure-v1/) —
  ...
  duration, and wide-screen sphere composition.
- [`autonomous-world-feel-v1/`](autonomous-world-feel-v1/) — completed historical
  evidence for presentation pacing, camera motion, responsive framing, and
  Result continuation.
