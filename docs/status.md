...
- Gameplay-disaster authority remains removed. Chronic Environment pressure is profile-driven and current-only persistence remains meta 14, settings 6, History 9, agent save 5, result/replay 8, and Worker protocol 8.
...
1. Rebuild History UX and visual truth, including resource/transformation/charge checkpoints.
2. Remove cell seams in WebGL2 and Canvas 2D.
3. Replace the old Evolution graph, retune ecology, establish direct Luminous value, and remove World Potential through realized-only SCORE.
