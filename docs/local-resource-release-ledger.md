...
| 7 | Monotone cumulative SCORE | SCORE v3 six cumulative merit ledgers, shared live/final model | 500 traces: zero decreases/mismatches; backend/speed final rerun pending | v1/v2 records legacy-separated | measured |
...
| 20 | Persistence/transactions | SCORE/build/reach/Trophy/History facts and migration validation updated | 143 unit + 73 integration currently pass; full gates pending | Exactly-once existing transaction retained | tested |
