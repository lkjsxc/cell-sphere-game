...
| `browser-file-test.mjs` | `npm run test:browser:file` | Socket-free real Chrome/WebGL mobile vertical slice: title tap, 32× extinction, Memory purchase, restart effect. |
