...
for (const name of ['lakeId', 'lakeDepth', 'lakeShore', 'freshwaterInfluence', 'lakes']) {
...
const report = { scannedFiles: sources.size, renderingFiles: renderingFiles.length, worldFiles: worldFiles.length,
  fourDraws: /drawCalls = 4/.test(renderer), fullCellLakes: !/cellPath\(cell\s*,/.test(staticGeography), violations };
